...
<!---Documatic-section-yeelight.main.discover_bulbs-start--->
## [yeelight.main.discover_bulbs](5-yeelight_main.md#yeelight.main.discover_bulbs)

<!---Documatic-section-discover_bulbs-start--->
```mermaid
flowchart LR
yeelight.main.discover_bulbs-->yeelight.main.get_ip_address
```

### Object Calls

* [yeelight.main.get_ip_address](5-yeelight_main.md#yeelight.main.get_ip_address)

<!---Documatic-block-yeelight.main.discover_bulbs-start--->
<details>
	<summary><code>yeelight.main.discover_bulbs</code> code snippet</summary>
...
<!---Documatic-block-yeelight.main.discover_bulbs-end--->
<!---Documatic-section-discover_bulbs-end--->

# #
<!---Documatic-section-yeelight.main.discover_bulbs-end--->

<!---Documatic-section-yeelight.main.BulbException-start--->
## [yeelight.main.BulbException](5-yeelight_main.md#yeelight.main.BulbException)

<!---Documatic-section-BulbException-start--->
<!---Documatic-block-yeelight.main.BulbException-start--->
<details>
	<summary><code>yeelight.main.BulbException</code> code snippet</summary>
...
<!---Documatic-block-yeelight.main.BulbException-end--->
<!---Documatic-section-BulbException-end--->

# #
<!---Documatic-section-yeelight.main.BulbException-end--->

<!---Documatic-section-yeelight.main.BulbType-start--->
## [yeelight.main.BulbType](5-yeelight_main.md#yeelight.main.BulbType)

<!---Documatic-section-BulbType-start--->
<!---Documatic-block-yeelight.main.BulbType-start--->
<details>
	<summary><code>yeelight.main.BulbType</code> code snippet</summary>
...
<!---Documatic-block-yeelight.main.BulbType-end--->
<!---Documatic-section-BulbType-end--->

# #
<!---Documatic-section-yeelight.main.BulbType-end--->

<!---Documatic-section-yeelight.main.Bulb-start--->
## [yeelight.main.Bulb](5-yeelight_main.md#yeelight.main.Bulb)

<!---Documatic-section-Bulb-start--->
<!---Documatic-block-yeelight.main.Bulb-start--->
<details>
	<summary><code>yeelight.main.Bulb</code> code snippet</summary>

```python
class Bulb(object):

    def __init__(self, ip, port=55443, effect='smooth', duration=300, auto_on=False, power_mode=PowerMode.LAST, model=None):
        """
    ...
    def get_properties(self, requested_properties=['power', 'bright', 'ct', 'rgb', 'hue', 'sat', 'color_mode', 'flowing', 'delayoff', 'music_on', 'nl_br', 'active_mode', 'bg_power', 'bg_rgb', 'name']):
        """
...
<!---Documatic-block-yeelight.main.Bulb-end--->
<!---Documatic-section-Bulb-end--->

# #
<!---Documatic-section-yeelight.main.Bulb-end--->

<!---Documatic-section-yeelight.main.get_ip_address-start--->
## [yeelight.main.get_ip_address](5-yeelight_main.md#yeelight.main.get_ip_address)

<!---Documatic-section-get_ip_address-start--->
<!---Documatic-block-yeelight.main.get_ip_address-start--->
<details>
	<summary><code>yeelight.main.get_ip_address</code> code snippet</summary>

```python
def get_ip_address(ifname):
    s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
    return socket.inet_ntoa(fcntl.ioctl(s.fileno(), 35093, struct.pack('256s', bytes(ifname[:15], 'utf-8')))[20:24])
```
</details>
<!---Documatic-block-yeelight.main.get_ip_address-end--->
<!---Documatic-section-get_ip_address-end--->

# #
<!---Documatic-section-yeelight.main.get_ip_address-end--->
